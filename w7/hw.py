def getAvailables(n, most_take=3):
	...
	return sorted(filter(lambda x: x != 0, set(availables + additional)))

def play(n = 4, most_take = 3, playerFirst = False, takeAllToWin = True):
...
play(most_take = 3, takeAllToWin = True, playerFirst = False)